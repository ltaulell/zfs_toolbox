...
# coding: utf-8
#
# $Id: gen_multipath_.py 3241 2021-04-13 13:15:52Z ltaulell $
...
def print_multipath(entries):
    ...
    if args.internal:
        ...
        # FIXME: external only deal with one disk array at a time
        if len(entries) == 12:
            print('# baie MD1200/1400 #{}'.format(baie))
        elif len(entries) == 24:
            print('# baie MD1240/1440 #{}'.format(baie))
        elif len(entries) == 60:
            print('# baie MD3060e #{}'.format(baie))
        elif len(entries) == 84:
            print('# baie ME484 #{}'.format(baie))
    ...
    for entry in entries:
        ...
        # TODO: need something for multiple disk arrays
...
if __name__ == "__main__":
    ...
    # TODO suivant la taille de la liste, deviner la taille de la baie ?
